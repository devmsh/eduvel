									...
									<tr>
										<td>
											<div class="thumb_cart">
												<img src="{{ asset('/uplaod/courses/coursesimages/'.$course['item']['course_image']) }}" alt="Image">
											</div>
											<a href="{{ url('/course-details/'.$course['item']['course_title']) }}"><span class="item_cart">{{ $course['item']['course_title'] }}</span></a>
										</td>
										<td>
										...
										<td class="options" style="width:5%; text-align:center;">
											...
											<a href="{{ url('/remove/'.$course['item']['id']) }}"><i class="icon-trash"></i></a>
										</td>
									</tr>
									@endforeach
							...
							<div class="float-left">
								...
								<div class="apply-coupon">
									<div class="form-group">
										...
										@endif
										<input type="text" name="coupon_code" placeholder="Your Coupon Code" class="form-control" required>
									</div>
									<div class="form-group">
