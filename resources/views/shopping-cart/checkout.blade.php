					...
					<div class="row">
							...
							<div class="step">
								<div class="row">
									<div class="col-sm-12">
										@if(!Auth::check())
											<div class="message">
												<p>Exisitng Customer? <a href="{{ url('/login') }}">Click here to login</a> Or <a href="{{ url('/register') }}">Sign up</a></p>
											</div>
										@else
											<div class="message">
						...
						<aside class="col-lg-4" id="sidebar">
							<div class="box_detail">
								...
								<a href="{{ url('/shopping-cart') }}" class="btn_1 full-width outline"><i class="icon-right"></i> Continue Shopping</a>
							</div>
						</aside>
					</div>
					<!-- /row -->
