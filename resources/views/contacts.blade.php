            ...
            <ul class="clearfix">
                ...
                <li>
                    ...
                    <span><a href="#" class="__cf_email__"
                             data-cfemail="e382878e8a90908a8c8da39687868e82cd808c8e">{{ $settings->email }}</a><br>{{-- <small>Monday to Friday 9am - 7pm</small> --}}</span>
        ...
        <div class="container margin_120_95">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6">
                    ...
                    <form method="post" action="/contacts" id="sendMessage" role="form" autocomplete="off">
                        <!--id="contactform" -->
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
									<span class="input">
										<input class="input_field" type="text" id="lastname_contact"
                                               name="lastname_contact" required="required"
                                               value="{{ old('lastname_contact') }}">
										<label class="input_label">
                            ...
                            <div class="col-md-6">
									<span class="input">
										<input class="input_field" type="email" id="email_contact" name="email_contact"
                                               required="required" value="{{ old('email_contact') }}">
										<label class="input_label">
                            ...
                            <div class="col-md-6">
									<span class="input">
										<input class="input_field" type="text" id="phone_contact" name="phone_contact"
                                               required="required" value="{{ old('phone_contact') }}">
										<label class="input_label">
                        ...
                        <span class="input">
									<textarea class="input_field" id="message_contact" name="message_contact"
                                              style="height:150px;"
                                              required="required"> {{ old('message_contact') }}</textarea>
									<label class="input_label">
