                        ...
                        <li>
                            <figure>
                                <img style="min-height: 213px;"
                                     src="{{ asset('uplaod/mediagallery/pictures/'.$value->image) }}" alt="">
                                <figcaption>
                                    <div class="caption-content">
                                        <a href="{{ asset('uplaod/mediagallery/pictures/'.$value->image) }}"
                                           title="{{ $value->title }}" data-effect="mfp-zoom-in">
                        ...
                        @if($value->category == "videos")
                            <li>
                                <figure>
                                    ...
                                    <img src="{{ asset('uplaod/mediagallery/videos/'.$value->image) }}"
                                         alt="{{ $value->title }}">
                                    <figcaption>
                                        <div class="caption-content">
                                            <a href="{{ asset('uplaod/mediagallery/videos/'.$value->image) }}"
                                               class="video" title="{{ $value->title }}">
