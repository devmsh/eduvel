...
<head>
  ...
  <title>Education Alzard - Dashboard</title>
	
  <!-- Favicons-->
  <link rel="shortcut icon" href="{{ url('/design/adminpanel') }}/img/favicon.ico" type="image/x-icon">
  <link rel="apple-touch-icon" type="image/x-icon" href="{{ url('/design/adminpanel') }}/img/apple-touch-icon-57x57-precomposed.png">
  <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="{{ url('/design/adminpanel') }}/img/apple-touch-icon-72x72-precomposed.png">
  <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="{{ url('/design/adminpanel') }}/img/apple-touch-icon-114x114-precomposed.png">
  <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="{{ url('/design/adminpanel') }}/img/apple-touch-icon-144x144-precomposed.png">
  ...
  <!-- Icon fonts-->
  <link href="{{ url('/design/adminpanel') }}/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
  <!-- Plugin styles -->
  ...
  <link href="{{ url('/fontawesome-iconpicker/css/fontawesome-iconpicker.min.css') }}" rel="stylesheet"> <!-- Error Botton -->
  <!-- End fontawesome-iconpicker CSS -->
  
</head>

<body class="fixed-nav sticky-footer" id="page-top"> {{-- do-nicescrol --}}