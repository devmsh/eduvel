<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Settings">
        <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#Settings"
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Accounts Users">
        <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#accountsUsers"
           data-parent="#exampleAccordion">
