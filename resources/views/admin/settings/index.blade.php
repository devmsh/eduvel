            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title_fixed" placeholder="Fixed Title"
                               value="{{ $setting->title_fixed }}">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control" name="description_fixed" style="height:100px;"
                                  placeholder="Fixed Description">{{ $setting->description_fixed }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <img class="img-thumbnail" src="{{ asset('uplaod/settings/'.$setting->image_story) }}"
                             alt="image_story">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control" id="article-ckeditor" name="description_story"
                                  style="height:100px;"
                                  placeholder="Description Story">{{ $setting->description_story }}</textarea>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control" name="description_footer" style="height:100px;"
                                  placeholder="Footer Description">{{ $setting->description_footer }}</textarea>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="copyright_website" placeholder="Copyright Website"
                               value="{{ $setting->copyright_website }}">
