      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="btn-group">
                <button type="button" class="btn btn-primary iconpicker-component py-2">Select Icon <i class="fa fa-fw fa-heart"></i></button>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea rows="5" class="form-control" name="description" style="height:100px;" placeholder="Description">{{ old('description') }}</textarea>
