                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="icon" class="form-control">
                            <option <?php if ($get->icon == 'pe-7s-diamond') {
                                echo "selected";
                            } ?> value="pe-7s-diamond">pe-7s-diamond
                            </option>
                            <option <?php if ($get->icon == 'pe-7s-display2') {
                                echo "selected";
                            } ?> value="pe-7s-display2">pe-7s-display2
                            </option>
                            <option <?php if ($get->icon == 'pe-7s-science') {
                                echo "selected";
                            } ?> value="pe-7s-science">pe-7s-science
                            </option>
                            <option <?php if ($get->icon == 'pe-7s-rocket') {
                                echo "selected";
                            } ?> value="pe-7s-rocket">pe-7s-rocket
                            </option>
                            <option <?php if ($get->icon == 'pe-7s-target') {
                                echo "selected";
                            } ?> value="pe-7s-target">pe-7s-target
                            </option>
                            <option <?php if ($get->icon == 'pe-7s-graph1') {
                                echo "selected";
                            } ?> value="pe-7s-graph1">pe-7s-graph1
                            </option>
                        </select>
                        @if($errors->has('icon'))
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control" name="description" style="height:100px;"
                                  placeholder="Description">{{ $get->description }}</textarea>
