                    ...
                    <li style="padding-left: 30px;">
                        ...
                        <div class="text-right">
                            @if($contact->done_read == 0)
                                <a href="messages/{{ $contact->id }}/done-read" class="btn_1 bg-primary"><i
                                            class="fa fa-fw fa-eye fa-lg"></i> Done Read</a>
                            @endif
                            <a href="messages/{{ $contact->id }}/destroy" class="btn_1 bg-danger" data-toggle="modal"
                               data-target="#sureDeleteMessage"><i class="fa fa-fw fa-close"></i> Deleted</a>
                        </div>
                    </li>
                @endforeach
            </ul>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="messages/{{ $contact->id }}/destroy" class="btn btn-danger"><i
