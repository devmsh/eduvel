                ...
                <td>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <select name="category" class="form-control">
                          <option <?php if($media_gallery->category == 'pictures'){echo "selected";} ?> value="pictures">pictures</option>
                          <option <?php if($media_gallery->category == 'videos'){echo "selected";} ?> value="videos">videos</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <h6>Title</h6>
                      <div class="form-group">
                        <input type="text" class="form-control" name="title" placeholder="Photo Title" value="{{ $media_gallery->title }}">
                      </div>
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                      <h6>Image Or Video</h6>
                      <div class="form-group">
                        <img style="width: 100%" class="" src="{{ asset('uplaod/mediagallery/'.$media_gallery->image) }}" alt="No Image">
                      </div>
                    </div>
                    <!-- <div class="col-md-2">
                      <div class="form-group">
