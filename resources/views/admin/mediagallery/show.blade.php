...
@section('content')
                    ...
                    <div class="container">  <!-- margin_60_35 -->
                        <div class="row">
                                    ...
                                    <p>
                                        @if($media_gallery->category == 'pictures')
                                            <img style="width: 100%" class=""
                                                 src="{{ asset('uplaod/mediagallery/pictures/'.$media_gallery->image) }}"
                                                 alt="No Image">
                                        @elseif($media_gallery->category == 'videos')
                                            <video width="400" controls>
                                                <source src="{{ asset('uplaod/mediagallery/videos/'.$media_gallery->image) }}"
                                                        type="video/mp4">
                            ...
                            <div class="col-lg-3">
                                <div class="postmeta">
                                    <ul>
                                        <li><a href="#"><i class="icon_folder-alt"></i> {{ $media_gallery->title }}</a>
                                        </li>
                                        <li><a href="#"><i class="icon_folder-alt"></i> {{ $media_gallery->category }}
                                            </a></li>
                                        <li><a href="#"><i
                                                        class="icon_clock_alt"></i> {{ $media_gallery->created_at->toDayDateTimeString() }}
                                            </a></li>
    ...
    <a href="{{ url('admin/media-gallery/'.$media_gallery->id.'/edit') }}" class="btn_1 bg-primary"><i
                class="fa fa-fw fa-edit"></i> Edit</a>
    <a href="{{ url('admin/media-gallery/'.$media_gallery->id.'/destroy') }}" class="btn_1 bg-danger"><i
