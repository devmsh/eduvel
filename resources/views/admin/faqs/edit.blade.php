            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" class="form-control" name="title" placeholder="Title FAQ"
                               value="{{ $faq->title }}">
                        @if($errors->has('title'))
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="category_faq" class="form-control">
                            <option <?php if ($faq->category_faq == 'Payments') {
                                echo "selected";
                            } ?> value="Payments">Payments
                            </option>
                            <option <?php if ($faq->category_faq == 'Suggestions') {
                                echo "selected";
                            } ?>  value="Suggestions">Suggestions
                            </option>
                            <option <?php if ($faq->category_faq == 'Reccomendations') {
                                echo "selected";
                            } ?>  value="Reccomendations">Reccomendations
                            </option>
                            <option <?php if ($faq->category_faq == 'Terms&conditons') {
                                echo "selected";
                            } ?>  value="Terms&conditons">Terms&conditons
                            </option>
                            <option <?php if ($faq->category_faq == 'Booking') {
                                echo "selected";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control" name="content" id="article-ckeditor"
                                  placeholder="Content FAQ">{{ $faq->content }}</textarea>
