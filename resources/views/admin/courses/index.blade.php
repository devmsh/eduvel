        ...
        <ul>
          ...
          <li>
            ...
            <ul class="buttons">
              ...
              <li><a href="{{ url('/admin/course/'.$course->id.'/approve') }}" class="btn_1 gray approve"><i class="fa fa-fw fa-check-circle-o"></i> Approve</a></li>
              @endif
              <li><a href="{{ url('/admin/course/'.$course->id.'/edit') }}" class="btn_1 gray badge-primary"><i class="fa fa-edit"></i> Edit</a></li>
