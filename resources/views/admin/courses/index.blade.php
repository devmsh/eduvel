            ...
            <div class="list_general">
                <ul>
                    @foreach($courses as $course)
                        <li>
                            <figure><img src="{{ asset('/uplaod/courses/coursesimages/'. $course->course_image) }}"
                                         alt=""></figure>
                            ...
                            <ul class="course_list">
                                <li><strong>Start date</strong> {{ date('d M Y', strtotime($course->course_start)) }}
                                </li>
                                <li><strong>Expire date</strong> {{ date('d M Y', strtotime($course->course_expire)) }}
                                </li>
                            ...
                            <ul class="buttons">
                                @if($course->isActive == 0)
                                    <li><a href="{{ url('/admin/course/'.$course->id.'/approve') }}"
                                           class="btn_1 gray approve"><i class="fa fa-fw fa-check-circle-o"></i> Approve</a>
                                    </li>
                                @endif
                                <li><a href="{{ url('/admin/course/'.$course->id.'/edit') }}"
                                       class="btn_1 gray badge-primary"><i class="fa fa-edit"></i> Edit</a></li>
                                <li><a href="{{ url('/dashboard/course/'.$course->id.'/delete') }}"
