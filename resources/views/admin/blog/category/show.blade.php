...
@section('content')
            ...
            <ul>
                @foreach($category->posts as $post)
                    <li style="">
                        ...
                        <figure style="border-radius: 0px;"><img
                                    src="{{ asset('design/educationalzard/img/avatar1.jpg') }}" alt=""></figure>
                        <h4>{{ $post->title }} </h4>
                        ...
                        <div class="text-right">
                            <a href="{{ url('/admin/blog/post/'.$post->id) }}" class="btn_1 bg-success"><i
                                        class="fa fa-eye"></i> Details</a>
                            @if($post->done_read == 0)
                                <a href="/admin/blog/post/{{ $post->id }}/edit" class="btn_1 bg-primary"><i
                                            class="fa fa-fw fa-edit"></i> Edit</a>
                            @endif
                            <a href="/admin/blog/post/{{ $post->id }}/destroy" class="btn_1 bg-danger"
                               data-toggle="modal" data-target="#sureDeleteMessage"><i class="fa fa-fw fa-close"></i>
                                Deleted</a>
                        </div>
                    </li>
                @endforeach
    ...
    <!-- Modal -->
    <div class="modal fade" id="sureDeleteMessage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="messages/{{ $category->id }}/destroy" class="btn btn-danger"><i
