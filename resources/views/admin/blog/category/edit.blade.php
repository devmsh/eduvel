...
@section('content')
 ...
 <!-- Breadcrumbs-->
  ...
  <form action="/admin/blog/category/update" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea rows="5" class="form-control" name="description" style="height:100px;" placeholder="Description Category">{{ $category->description }}</textarea>
