...
@section('content')
 ...
 <!-- Breadcrumbs-->
  ...
  @include('admin.layouts.message')
					...
					<div class="container">  <!-- margin_60_35 -->
						<div class="row">
									...
									<ul>
										...
										@foreach($post->blog_comments as $comm)
											<li style="padding: 25px 0 0 0; list-style: none;">
												<div class="avatar">
													<a class="a" href="#"><img class="img" src="{{ asset('design/educationalzard/img/avatar1.jpg') }}" alt="">
													</a>
												</div>
												<div class="comment_right clearfix">
													<div class="comment_info">
														By <a href="#">{{ $comm->name }}</a><b>|</b>{{ $comm->created_at->toDateString() }}<b>|</b><a href="{{ $comm->website }}">Reply</a> <span class="float-right">{{ \Carbon\Carbon::parse($comm->created_at)->diffForHumans() }}</span>
													</div>
													<p>
														{{ $comm->comment }}.
													</p>
													<a href="/admin/blog/comment/{{ $comm->id }}/destroy" class="btn_1 bg-danger float-right mb-2" data-toggle="modal" data-target="#sureDeleteComment"><i class="fa fa-close"></i> Remove Comment</a>
												</div>
											</li>
										@endforeach
									</ul>
							...
							<div class="col-lg-3">
								<div class="postmeta">
									<ul>
										<li><a href="#"><i class="icon_folder-alt"></i> {{ $name_category->name }}</a></li>
	...
	<a href="/admin/blog/post/{{ $post->id }}/destroy" class="btn_1 bg-danger" data-toggle="modal" data-target="#sureDeletePost"><i class="fa fa-fw fa-close"></i> Deleted</a>
    ...
    <!-- Modal -->
	<div class="modal fade" id="sureDeleteComment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Message sure </h5>
