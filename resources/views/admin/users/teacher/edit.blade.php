    ...
    <form action="update" method="POST" enctype="multipart/form-data">
        ...
        <div class="box_general padding_bottom">
            <div class="header_box version_2">
                <h2><i class="fa fa-user"></i>Edit details</h2>
            </div>
            <div class="row">
        ...
        <div class="box_general padding_bottom">
            ...
            <div class="row add_top_30">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Telephone</label>
                        <input type="text" class="form-control" name="telephone" value="{{ $admission->telephone }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Age</label>
                        <input type="text" class="form-control" name="age" value="{{ $admission->age }}"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea style="height:100px;" class="form-control" id="article-ckeditor-description-course"
                                  name="messagere_here"
                                  placeholder="Personal info">{!! $admission->messagere_here !!}</textarea>
                    </div>
                </div>
            </div>
            <!-- /row-->
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <select class="form-control required" name="education_level" id="education_apply"
                            ...
                            <option @if($admission->education_level == 'Less than high school') selected
                                    @endif value="Less than high school">Less than high school
                            </option>
                            <option @if($admission->education_level == 'High school diploma or equivalent') selected
                                    @endif value="High school diploma or equivalent">High school diploma or equivalent
                            </option>
                            <option @if($admission->education_level == 'Some college no degree') selected
                                    @endif value="Some college no degree">Some college, no degree
                            </option>
                            <option @if($admission->education_level == 'Bachelor degree') selected
                                    @endif value="Bachelor degree">Bachelor’s degree
                            </option>
                            <option @if($admission->education_level == 'Doctoral or professional degree') selected
                                    @endif value="Doctoral or professional degree">Doctoral or professional degree
                            </option>
                        </select>
            ...
            <div class="row add_top_30">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>City</label>
                        <input type="text" class="form-control" name="city" value="{{ $admission->city }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Zipcode</label>
                        <input type="text" class="form-control" name="zipcode" value="{{ $admission->zipcode }}"
                               placeholder="Zipcode">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control required" name="country">
                            ...
                            <option @if($admission->country == 'North America') selected @endif value="North America">
                                North America
                            </option>
                            <option @if($admission->country == 'South America') selected @endif value="South America">
                                South America
                            </option>
                        </select>
                    ...
                    <div class="header_box version_2">
                        ...
                        @for($i = 0; $i < count($arr_preferences); $i++)
                            <div class="form-group radio_input">
                                <label><input type="checkbox" checked value="{{ $arr_preferences[$i] }}"
                                              name="preferences[]" class="icheck"> {{ $arr_preferences[$i] }}</label>
                            </div>
                        @endfor
                        {{-- <div class="form-group radio_input">
