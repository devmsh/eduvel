      ...
      <div class="col-md-6">
        <div class="box_general padding_bottom">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="new_email" value="{{ old('new_email') }}" id="new_email" type="email">
          </div>
          <div class="form-group">
            <label>Confirm new email</label>
            <input class="form-control" name="confirm_new_email" value="{{ old('confirm_new_email') }}" id="confirm_new_email" type="email">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="header_box version_2">
        ...
        <div class="row add_top_30">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="telephone" value="{{ old('telephone') }}" placeholder="Your telephone number">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Age</label>
                <input type="text" class="form-control" name="age" value="{{ old('age') }}" placeholder="Your age">
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label>Personal info</label>
                <textarea style="height:100px;" class="form-control" id="article-ckeditor-description-course" name="messagere_here" placeholder="Personal info">{!! old('messagere_here') !!}</textarea>
              </div>
            </div>
        </div>
        <!-- /row-->
        ...
        <div class="row add_top_30">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>City</label>
                <input type="text" class="form-control" name="city" value="{{ old('city') }}" placeholder="Your city">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
