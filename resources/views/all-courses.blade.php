            ...
            <ul class="clearfix">
                ...
                <li>
                    <div class="layout_view">
                        <a href="{{ url('courses-grid') }}" class="active"><i class="icon-th"></i></a>
                ...
                <li style="min-width: 150px;">
                    <select name="orderby" class="selectbox" onchange="javascript:handleSelect(this)">
                        <option value="/all-courses">Select Category</option>
                            ...
                            <figure class="block-reveal">
                                ...
                                <a href="{{ url('course-details/'.$course->course_title) }}">
                                    ...
                                    <img style="max-height: 350px;"
                                         src="{{ asset('/uplaod/courses/coursesimages/'. $course->course_image) }}"
                                         class="img-fluid" alt="">
                                </a>
