			...
			<figure>
			  ...
			  <form method="POST">
				...
				<div class="form-group">
					...
					<span class="input">
					<input class="input_field" required type="email" autocomplete="off" name="email" value="{{ $data->email }}">
					...
					<span class="input">
					<input class="input_field" required type="password" autocomplete="new-password" name="password_confirmation">
						<label class="input_label">
				...
				<div class="text-center add_top_10">New to Udema? <strong><a href="{{ url('/login') }}">Sign in!</a></strong></div>
			</form>
