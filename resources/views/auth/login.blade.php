    ...
    <aside>
        ...
        <form action="/login" method="POST">
            ...
            <div class="access_social">
                ...
                <a href="{{ url('login/twitter') }}" class="social_bt {{-- linkedin --}}"
                   style="background-color: #0077B5;"><i class="ti-twitter-alt float-left"></i>Login with Twitter</a>
            </div>
            ...
            <div class="text-center add_top_10">New to Udema? <strong><a href="{{ url('/register') }}">Sign
                        up!</a></strong></div>
        </form>
