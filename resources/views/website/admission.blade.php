			...
			<form method="POST">  <!-- name="example-1" id="wrapped"  -->
				...
				<div id="middle-wizard">
					...
					<div class="step">
						...
						<div class="form-group">
							<input type="email" name="email" class="form-control required" placeholder="Your Email" value="{{ $data->email }}">
							@if($errors->has('email'))
						...
						<div class="form-group">
							<input type="text" name="telephone" class="form-control" placeholder="Your Telephone" value="{{ old('telephone')}}">
						...
						<div class="form-group select">
							<div class="styled-select">
								<select class="required" name="education_level" id="education_apply" value="{{ old('education_level')}}">
					...
					<div class="step">
						...
						<div class="form-group">
							<input type="text" name="zipcode" class="form-control required" placeholder="Zip code" value="{{ old('zipcode')}}">
					...
					<div class="submit step">
						...
						<div class="form-group add_top_30">
							<textarea name="messagere_here" class="form-control required" style="height:120px;" placeholder="Hello world....write your messagere here!"></textarea>
