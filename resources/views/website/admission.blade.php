...
<div id="form_container" class="clearfix">
    ...
    <div id="wizard_container">
        ...
        <!-- /top-wizard -->
        <form method="POST">  <!-- name="example-1" id="wrapped"  -->
            {{ csrf_field() }}
            ...
            <div id="middle-wizard">
                <div class="step">
                    <div id="intro">
                        <figure><img src="{{ url('/design/educationalzard') }}/img/wizard_intro_icon.svg" alt="">
                        </figure>
                        <h1>Admission Apply</h1>
                        <p>Exerci tibique eum cu, paulo appellantur et mei, ea partem urbanitas vim. His ei iusto
                            nonumes atomorum. Mentitum pericula in nec. In eos habemus tibique. </p>
                        <p><strong>Mel erant legere iuvaret ea. At eum doctus voluptatibus, has id veritus
                                constituam.</strong></p>
                    </div>
                </div>
...
@if($errors->has('lastname'))
                ...
                <!-- <div class="form-group">
                    ...
                    {{-- <div class="form-group">
                        <div class="styled-select">
                            <select class="required" name="educational_status" value="{{ old('educational_status')}}">
                                <option value="" selected>Your educational status</option>
                                <option value="Teacher">Teacher</option>
                                <option value="Student">Student</option>
                            </select>
                            @if($errors->has('educational_status'))
                              <small style="color: red">{{ $errors->first('educational_status') }}</small>
                            @endif
                        </div>
                    </div> --}}
                    <div class="form-group select">
                        <div class="styled-select">
                            <select class="required" name="education_level" id="education_apply"
                                    value="{{ old('education_level')}}">
                                <option value="" selected="">Select your education level</option>
                                <option value="Less than high school">Less than high school</option>
                                <option value="High school diploma or equivalent">High school diploma or equivalent
                                </option>
                ...
                <div class="step">
                    ...
                    <div class="form-group">
                        <input type="text" name="zipcode" class="form-control required" placeholder="Zip code"
                               value="{{ old('zipcode')}}">
                    ...
                    <div class="form-group">
                        <div class="styled-select">
                            <select class="required" name="country" value="{{ old('email')}}">
                ...
                <div class="submit step">
                    ...
                    <div class="form-group radio_input">
                        <label><input type="checkbox" value="Management" name="preferences[]" class="icheck">Management
                            adn Business</label>
                    </div>
                    <div class="form-group radio_input">
                    ...
                    <div class="form-group radio_input">
                        <label><input type="checkbox" value="Litteratture" name="preferences[]" class="icheck">Litteratture:
                            Poetry</label>
                    </div>
                    <div class="form-group radio_input">
                    ...
                    <div class="form-group add_top_30">
                        <textarea name="messagere_here" class="form-control required" style="height:120px;"
                                  placeholder="Hello world....write your messagere here!"></textarea>
                        @if($errors->has('messagere_here'))
                            <small style="color: red">{{ $errors->first('messagere_here') }}</small>
                        @endif
                    </div>
                    <div class="form-group terms">
                        ...
                        <label>Please accept <a href="#" data-toggle="modal" data-target="#terms-txt">terms and
                                conditions</a> ?</label>
                        @if($errors->has('terms'))
                            <small style="color: red">{{ $errors->first('terms') }}</small>
                        @endif
                        @if(Session::has('error_terms'))
                            <small style="color: red">{!! session('error_terms') !!}</small>
                        @endif
                    </div>
                </div>
                <!-- /step-->
