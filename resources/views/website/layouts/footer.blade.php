		...
		<div class="container margin_120_95">
			<div class="row">
				<div class="col-lg-5 col-md-12 p-r-5">
					<p><a href="{{ url('/') }}"><img src="{{ url('/design/educationalzard') }}/img/logo.png" width="149" height="42" data-retina="true" alt=""></a></p>
				...
				<div class="col-lg-3 col-md-6">
					...
					<ul class="contacts">
						...
						<li><a href="mailto:Enter%20an%20email?subject=Your%20Subject%20Line&body=Thought%20you%20might%20be%20interested%20in%20this%20http://education-alzard.devany.co">{{ $settings->email }}</span></a></li>
					</ul>
					<div id="newsletter">
					<h6>Newsletter</h6>
					<div id="message-newsletter"></div>
					<form method="post" action="/newsletter_form" role="form" autocomplete="off" name="newsletter_form" id="newsletter_form">
						{{ csrf_field() }}
            ...
            <li>
              <style >.goog-te-gadget-simple .goog-te-menu-value span{color: #000; font-weight: bold;}</style>
	...
	<!-- COMMON SCRIPTS -->
    <script data-cfasync="false" src="{{ url('/design/educationalzard') }}/../../cdn-cgi/scripts/d07b1474/cloudflare-static/email-decode.min.js"></script><script src="{{ url('/design/educationalzard') }}/js/jquery-2.2.4.min.js"></script>
	...
	<!-- SPECIFIC SCRIPTS -->
	<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&key=AIzaSyDplYGVpx6IcbMvo8JolTz_D3ENJpgQcsA"></script>
