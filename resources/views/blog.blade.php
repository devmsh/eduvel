                    ...
                    @foreach($posts as $post)
                        <article class="blog wow fadeIn">
                            <div class="row no-gutters">
                                <div class="col-lg-7">
                                    <figure>
                                        <a href="/blog/blog-post/{{ $post->id }}"><img
                                                    src="{{ asset('uplaod/posts/'.$post->image) }}" alt="">
                                ...
                                <div class="col-lg-5">
                                    <div class="post_info">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="thumb"><img
                                                            src="{{ asset('design/educationalzard/img/thumb_blog.jpg') }}"
                                                            alt=""></div>
                                                Jessica Hoops
                                            </li>
                                            <li><i class="icon_comment_alt"></i> 20</li>
                                ...
                                <ul>
                                    ...
                                    @foreach($categories as $category)
                                        <li>
                                            ...
                                            <a @if(!empty($id) && $id == $category->id)  style="color: #392779 !important; font-weight: 700;"
                                               @endif href="{{ url('/blog/category/'.$category->id) }}">{{ $category->name }}
