                                ...
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0">
                                        <a class="collapsed" data-toggle="collapse"
                                           href="#collapse{{ $faq->id }}_payment" aria-expanded="false">
                                            <i class="indicator ti-plus"></i>{{ $faq->title }}
                                        </a>
                                    </h5>
                                </div>
                                <div id="collapse{{ $faq->id }}_payment" class="collapse" role="tabpanel"
                                     data-parent="#payment">
                                    <div class="card-body">
                                        <p>{!! $faq->content !!}.</p>
                                    </div>
                    ...
                    @foreach($faqs as $faq)
                        @if($faq->category_faq == "Suggestions")
                            <div class="card">
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0">
                                        <a data-toggle="collapse" href="#collapse{{ $faq->id }}_tips"
                                           aria-expanded="true"><i class="indicator ti-plus"></i>{{ $faq->title }}</a>
                                    </h5>
                                </div>

                                <div id="collapse{{ $faq->id }}_tips" class="collapse" role="tabpanel"
                                     data-parent="#tips">
                                    <div class="card-body">
                                        <p>{!! $faq->content !!} .</p>
                                    </div>
                    ...
                    @foreach($faqs as $faq)
                        @if($faq->category_faq == "Reccomendations")
                            <div class="card">
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0">
                                        <a data-toggle="collapse" href="#collapse{{ $faq->id }}_reccomendations"
                                           aria-expanded="true"><i class="indicator ti-plus"></i>{{ $faq->title }}</a>
                                    </h5>
                                </div>

                                <div id="collapse{{ $faq->id }}_reccomendations" class="collapse" role="tabpanel"
                    ...
                    @foreach($faqs as $faq)
                        @if($faq->category_faq == "Terms&conditons")
                            <div class="card">
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0">
                                        <a data-toggle="collapse" href="#collapse{{ $faq->id }}_terms"
                                           aria-expanded="true"><i class="indicator ti-plus"></i>{{ $faq->title }}</a>
                                    </h5>
                                </div>

                                <div id="collapse{{ $faq->id }}_terms" class="collapse" role="tabpanel"
                                     data-parent="#terms">
                                    <div class="card-body">
                                        <p>{!! $faq->content !!}.</p>
                                    </div>
                    ...
                    @foreach($faqs as $faq)
                        @if($faq->category_faq == "Booking")
                            <div class="card">
                                <div class="card-header" role="tab">
                                    <h5 class="mb-0">
                                        <a data-toggle="collapse" href="#collapse{{ $faq->id }}_booking"
                                           aria-expanded="true"><i class="indicator ti-plus"></i>{{ $faq->title }}</a>
                                    </h5>
                                </div>

                                <div id="collapse{{ $faq->id }}_booking" class="collapse" role="tabpanel"
                                     data-parent="#booking">
                                    <div class="card-body">
                                        <p>{!! $faq->content !!}.</p>
                                    </div>
