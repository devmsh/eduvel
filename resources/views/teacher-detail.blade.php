		...
		<div class="container margin_60_35">
			<div class="row">
				<aside class="col-lg-3" id="sidebar">
					<div class="profile">
						<figure><img style="max-width: 100%" src="{{ asset('uplaod/user/'.$teacher_detail->image) }}" alt="Teacher" class="rounded-circle"></figure>
									...
									<tbody>
										...
										<tr>
											@foreach($course_categorys as $course_category)
												...
												@endif
											@endforeach
											<td><a href="{{ url('/course-details/'.$myCourse->course_title) }}">{{ $myCourse->course_title }}</a></td>
